...
// console.log(parseFloat(x)); // 문자열 -> 정수

// 참고 : 이렇게 사용 X
// let x = "apple";
// NaN 에러발생 : (Not a Number)
// console.log(Number(x)); // 에러 발생
...
// TODO: 4) 배열의 갈아 : 배열변수.length (반복문에 많이 사용)
// let animals = ["사자", "호랑이", "사슴", "펭귄"];
...
// TODO: 6) 문자열 자르기 함수
// 사용법 : 문자열.substr(시작 인덱스번호, 끝 인덱스번호);
//         (시작 번호~ 끝 번호-1까지 잘림)
...
// let str2 = str.toUpperCase(); // 대문자로 바꾸기
// console.log("str2", str2);
// let str3 = str.toLowerCase(); // 소문자로 바꾸기
...
// console.log("Math.min",Math.min(-5, 7, 0, 12));

// 최대값
// 사용법 : Math.max(값, 값2...값n) -> 최대값
// console.log("Math.max",Math.max(-5, 7, 0, 12));

// 제곱
// 사용법 : Math.pow(숫자, 제곱수)
// console.log("Math.pow",Math.pow(7, 12));
...
let month = date.getMonth()+1; // 월 (0부터 시작해서 1더해줘야함)
