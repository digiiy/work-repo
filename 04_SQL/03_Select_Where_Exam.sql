...
AND DNO = 20 OR DNO = 30 ORDER BY ENAME ASC;
...
-- 사원테이블 : EMPLOYEE
SELECT ENAME, SALARY, COMMISSION FROM EMPLOYEE WHERE COMMISSION IS NOT NULL ORDER BY SALARY DESC;
...
-- 사원 테이블 : EMPLOYEE
SELECT ENAME, JOB, SALARY FROM EMPLOYEE WHERE JOB = 'CLERK' OR JOB = 'SALESMAN'
...
SELECT * FROM EMPLOYEE WHERE DNO = 20 OR DNO = 30 AND SALARY > 2000; 
