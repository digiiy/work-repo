...
/**
 * packageName : com.example.controllerexam.exam01
 * fileName : HelloController
 * author : GGG
 * date : 2023-10-04
 * description : JSP, 타임리프 : SSR (Server Side Rendering)
 *                   1) 구조 => Springboot 소스가 같이 있음
 *                   2) html 파일을 Springboot 에서 만들어서 웹 브라우저로 전송gka
 *               React/Vue    : CSR (Client Side Rendering)
 *                   1) 구조 => 소스가 분리됨
 *                   2) html 파일을 최초 1회 전송하교
 *                    => 다음부터는 변경되는 부분만 서버에서 받고, 나머지는 웹브라우저에 만듬
 *               @GetMapping(url)함수() {return "jsp페이지명";}
 *               => CRUD => Read 요청일때 사용하는 이노테이션
 * 요약 :
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
...
//    TODO: 연습 1) url : /exam01/hello2 에 "안녕 hello2 페이지" 출력하기
//                                         "Springboot 처음이지"
//                                         "수고해!!!"
...
public String Hello3(Model model){
    ...
    model.addAttribute("greeting2", "JSP에는 JSTL");
